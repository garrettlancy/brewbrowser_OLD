...
<div class="container">
	<h2>Update Beer</h2>
	<c:url var="formAction" value="/updateBeer" />
	<form:form id="form0" action="${formAction}" method="POST"
		modelAttribute="beer">

		<div>
			<label for="name">Beer Name</label><br>
			<form:input class="textbox" path="name" placeholder="Enter Beer Name" />
			<form:errors path="name" cssClass="error" />
		</div>
		<br>
		<div>
			<label for="alcoholPercentage">Beer Alcohol Percentage</label><br>
			<form:input class="textbox" path="alcoholPercentage" placeholder="0.0%" />
			<form:errors path="alcoholPercentage" cssClass="error" />
		</div>
		<br>
		<div>
